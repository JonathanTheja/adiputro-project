                ...
                `<div class="w-9/12 rounded-lg py-5">
                    ...
                    <div>
                        <div class="flex flex-wrap -mx-3 mb-2">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="component_input_`+input_selected.val()+`" type="text" placeholder="Kode Komponen">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none" onclick="addRowTable('`+body_name+`','`+input_selected.val()+`')">+</button>
                            </div>
                        </div>
