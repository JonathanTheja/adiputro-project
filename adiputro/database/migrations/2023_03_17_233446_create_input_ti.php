...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('input_ti', function (Blueprint $table) {
            ...
            // $table->string('level_proses_input_ti'); one to many
            // $table->string('kode_komponen_ti'); one to many
            $table->string('model'); // department_id
            $table->integer('pembuat_id'); //user login
            // $table->string('diperiksa_oleh_ti'); many to many
            // $table->string('approved_by_ti'); many to many
            $table->integer('user_defined_id');
            $table->string('description');
            // $table->string('nama_gambar_ti'); one to many
            $table->timestamps();
            $table->softDeletes();
        });
    }
